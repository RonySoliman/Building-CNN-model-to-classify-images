...
#
python3 check_images.py --dir uploaded_images/ --arch resnet  --dogfile dognames.txt
python3 check_images.py --dir uploaded_images/ --arch alexnet --dogfile dognames.txt
python3 check_images.py --dir uploaded_images/ --arch vgg  --dogfile dognames.txt
