    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            if line not in  dognames_dic:
                ...
                print(f"Warning {Line} already exist in the dogsnames_dic attribute!")
...
# for this reason [If a dog name already exists in dognames_dic print a Warning statement because you shouldn't find any duplicate dog names in dognames.txt]
# @@@@@@@@@@@ you can put dognames_dic inside a set because set isn't accept duplicates and still mutable!!!
#  instead of using append, use add()