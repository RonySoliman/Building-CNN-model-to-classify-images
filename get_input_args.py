...
def get_input_args():
    ...
    def add_argument(arg1,arg2,arg3):
        parser.add_argument(arg1,type=str,default=arg2,help=arg3)
        
    add_argument('--dir','pet_images/','Folder that contains the pet images')
    add_argument('--arch','vgg','the CNN model architecture to use')
    add_argument('--dogfile','dognames.txt','The file that contains the list of valid dognames')
